...
class Product(models.Model):
    ...
    image =models.ImageField(null=True , blank=True , default='/download (1).png')
    ...
    show =models.BooleanField(null=True , blank=True ,default=False)
...
class Order(models.Model):
    ...
    createdAt =models.DateTimeField(auto_now_add=True)
    _id = models.AutoField(primary_key=True , editable=False)
    copun =models.ForeignKey('Copun', on_delete=models.SET_NULL,null=True , blank=True)
    def __str__(self):
        return str(self._id)
