...
export const productDetailsAdminReducer = (
  state = { product: { reviews: [] } },
  action
) => {
  switch (action.type) {
...
export const productCoponReducer = (state = {}, action) => {
  switch (action.type) {
    case PRODUCT_ADD_COPON_REQUEST:
      return { loading: true };
    case PRODUCT_ADD_COPON_SUCCESS:
      return { loading: false, success: true };
    case PRODUCT_ADD_COPON_FAIL:
      return { loading: false, error: action.payload };
    case PRODUCT_ADD_COPON_RESET:
      return {};
    default:
      return state;
  }
